...
const Sidebar = () => {
    ...
    return (
        <aside className="fixed top-0 left-0 h-screen w-64 bg-white border-r border-gray-100 shadow-2xl flex flex-col z-40 transition-all duration-300">
            {/* Header - Logo */}
            <div className="relative p-8 border-b border-gray-50 bg-green-700 text-white overflow-hidden">
            ...
            <div className="flex-grow overflow-y-auto custom-scrollbar">
                ...
                {/* Section: Météo Locale - Placeholder Premium
                <div className="mx-4 p-4 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl text-white shadow-lg shadow-blue-100 flex items-center justify-between group overflow-hidden relative mb-4">
                    <div className="absolute top-0 right-0 p-2 opacity-20 group-hover:scale-125 transition-transform duration-500">
                        <CloudSun size={60} />
                    </div>
                    <div className="relative">
                        <p className="text-[10px] font-bold uppercase opacity-80 tracking-wider">Météo Locale</p>
                        <p className="text-2xl font-bold">28°C</p>
                        <p className="text-[10px] font-medium opacity-90">Ciel dégagé • Korhogo</p>
                    </div>
                </div> */}

                {/* Section: Alertes & Tâches
                <div className="p-4 space-y-1">
                    <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest px-4 mb-2">Alertes & Tâches</p>
                    <div className="px-4 py-3 bg-red-50 border border-red-100 rounded-xl flex items-start gap-3">
                        <div className="mt-1 p-1.5 bg-red-100 text-red-600 rounded-lg">
                            <Bell size={14} className="animate-swing" />
                        </div>
                        <div>
                            <p className="text-xs font-bold text-red-800">Irrigation requise</p>
                            <p className="text-[10px] text-red-600">Parcelle Nord • Maïs</p>
                        </div>
                    </div>
                </div> */}
